...
3 This might help, if you decide to implement the feature: http://cseweb.ucsd.edu/~ccalabro/essays/15_puzzle.pdf 4 As a hint, read up on the A* search algorithm: http://en.wikipedia.org/wiki/A*_search_algorithm
